...
| `app-flutter/` | flutter → APK | 🟡 W3:脚手架 + 生成线 + 四页 UI/导航 + `/analyze` 真联调 + 本地历史闭环 + 合规文案核对 + **APK 已出包**(46MB debug 签名),装机自测留用户(见 `.project/tasks/W3-frontend-app-flutter.md`) |
